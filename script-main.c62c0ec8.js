...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script-unsplash-api.js":[function(require,module,exports) {
"use strict";
...
function fetchUnsplashApi() {
  ...
  fetch(unsplashUserPhotos).then(function (resp) {
    return resp.json();
  }).then(function (response) {// console.log('unsplash', response);
...
exports.getRandomQuote = exports.stackGrid = exports.aboutWrapper = exports.projectWrapper = exports.isNavButtonOpen = exports.buttonQuote = exports.heroDesc = exports.heroTitle = exports.heroList = exports.navigationItems = exports.navButton = void 0;
...
},{"./script-firebase-api.js":"script-firebase-api.js"}],"script-firebase-api.js":[function(require,module,exports) {
"use strict";
