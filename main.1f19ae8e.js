...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"script-dom.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  listenNavEvents: listenNavEvents
};
exports.default = _default;
},{}],"unsplash-api.js":[function(require,module,exports) {
"use strict";
...
function fetchUnsplashApi() {
  ...
  var unsplashMyCollention = 'https://api.unsplash.com/users/daxtersky/collection/9522596?client_id=c1462734c4e2f7d399a2724533d58445eecb3b969c50f37262cc96c7f7acedc0'; // fetch(unsplashUserPhotos)
  //   .then(resp => resp.json())
  //   .then(response => {
...
exports.default = _default;
},{}],"script-awslambda-api.js":[function(require,module,exports) {
"use strict";
...
var getAwsLambdaFunctions = function getAwsLambdaFunctions() {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      var sendEmail = 'https://f9akte6bf8.execute-api.eu-west-1.amazonaws.com/default/mikeystudio_send_email' + "?param1=".concat(inputEmail.value) + "&param2=".concat(inputMessage.value);
      var data = {
        'param1': inputEmail.value,
        'param2': inputMessage.value
      };
      console.log('data', data); // TODO try handling aws functions' fetch with arrow funtions... maybe it'll help? point no. 5 https://dmitripavlutin.com/javascript-arrow-functions-best-practices/
...
var listenToObserver = function listenToObserver() {
  ...
  var observer = new IntersectionObserver(function (entries) {
    entries.forEach(function (entry) {
      var id = entry.target.getAttribute('id'); // console.log(entry);
      ...
      if (entry.intersectionRatio > 0) {
        ...
        document.querySelector("nav ul li a[href=\"#".concat(id, "\"]")).parentElement.classList.remove('active');
      }
    });
  }, {
...
var _scriptDom = _interopRequireDefault(require("./script-dom.js"));

var _unsplashApi = _interopRequireDefault(require("./unsplash-api.js"));

var _scriptFirebaseApi = _interopRequireDefault(require("./script-firebase-api.js"));

var _scriptAwslambdaApi = _interopRequireDefault(require("./script-awslambda-api.js"));
...
document.addEventListener("DOMContentLoaded", function () {
      ...
      if (firebaseDatabase) {
        ...
        if (firebaseDatabase.aboutList) {
          firebaseDatabase.aboutList.forEach(function (aboutItem) {
            ...
            aboutSection.classList.add("".concat(aboutItem.className));
  ...
  var getUnsplashData = function getUnsplashData() {
    return _unsplashApi.default.fetchUnsplashApi();
  };

  var getEmailService = function getEmailService() {
    return _scriptAwslambdaApi.default.getAwsLambdaFunctions();
  };
  ...
  getUnsplashData();
  getEmailService();
  getIntersectionObserver(); // handleForm()
});
...
var showNewQuote = function showNewQuote(randomQuote) {
  ...
  var quoteLinkDom = document.getElementsByClassName('quote-link')[0]; // TODO sizes for tablet only ;)
...
var handleForm = function handleForm() {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault(); // return alert('Hurray! Mail was sent successfully! :)')
...
},{"./script-dom.js":"script-dom.js","./unsplash-api.js":"unsplash-api.js","./script-firebase-api.js":"script-firebase-api.js","./script-awslambda-api.js":"script-awslambda-api.js","./script-intersection-observer.js":"script-intersection-observer.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
